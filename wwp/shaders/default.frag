...
//region Mountains (https://www.shadertoy.com/view/fsdGWf)
...
//region Starfield (from https://www.shadertoy.com/view/NtsBzB)
...
//region CLOUDS (https://www.shadertoy.com/view/Xs23zX)
...
#if DEF_LAMBDA
  // if cloud overcast, desaturate and dim
  float Lc = length(L) - smoothstep(0.9, 1.0, overcast);
